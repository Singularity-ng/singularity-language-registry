...
impl LanguageRegistry {
    ...
    pub fn detect_language(&self, file_path: &Path) -> Result<&LanguageInfo> {
        ...
        let extension = file_path
            ...
            .ok_or_else(|| anyhow::anyhow!("Cannot detect language: no file extension for {:?}", file_path))?;
        ...
        self.languages
            .get(language_id)
            .ok_or_else(|| anyhow::anyhow!("Internal error: language '{}' missing from registry", language_id))
    }
